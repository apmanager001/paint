...
const ExistingCanvas = ({
  ...
  const disableColorChanges = useCallback((setGrid, clickedSquares) => {
    setGrid((prevGrid) => {
  ...
  const handleChangeColor = useCallback(
    ...
    [gridChangeable, colorMapping, colorClasses]
  );
  ...
  }, [moves, disableColorChanges, clickedSquares]);
  ...
  }, [gridChangeable, handleChangeColor, styles.square]);
